...
SECRET_KEY = 'django-insecure-6uu%bu!ae-=6u@6&%x=s)jobf2$*2q=@j990=9jc^(%3p$buto'
...
DEFAULT_FROM_EMAIL = "sgorobetsky@yandex.ru"

SERVER_EMAIL = "sgorobetsky@yandex.ru"
MANAGERS = (
    ('Ivan', 'ivan@yandex.ru'),
    ('Petr', 'petr@yandex.ru'),
)
